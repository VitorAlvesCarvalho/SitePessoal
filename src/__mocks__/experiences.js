export const experiences = [
  {
    id: "1",
    company: "HMS Consulting",
    role: "Desenvolvedor de software",
    description:
      "<ul> <li>Desenvolvimento de aplicações web</li> <li>Manutenção em sistema de estoque</li> <li>Desenvolvimento de aplicação mobile hibrida</li> </ul>",
    time: "Out de 2019 - Dez de 2019 · 3 meses",
  },
  {
    id: "2",
    company: "Nagro",
    ...
    description:
      "<ul> <li>Manutenção e desenvolvimento de novas funcionalidades em sistema web que auxilia a análise de crédito pra produtores rurais</li> <li>Participação ativa no desenvolvimento de aplicação mobile utilizando Flutter.</li> </ul>",
    time: "Jan de 2020 - Mar de 2021 · 1 ano e 3 meses",
  },
  {
    id: "3",
    company: "BoxTI",
    role: "Desenvolvedor Front-end | Vue e chapter lead web",
    description:
      "<ul> <li>Como desenvolvedor front web, atuava alocado no principal cliente da empresa, a Warren Brasil, iniciando projeto de parceria entre as empresas, para alocação de funcionários.</li> <li>Como chapter lead web, atuava como liderança técnica responsável por auxiliar e tirar dúvidas do dia a dia de trabalho dos demais desenvolvedores front da empresa e aplicar treinamento através de coding dojo que eram feitos de duas em duas semanas.</li> </ul>",
    time: "Mar de 2021 - Dez de 2021 · 10 meses",
  },
  {
    id: "4",
